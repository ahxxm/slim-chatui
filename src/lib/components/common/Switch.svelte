...
>
	<Switch.Root
		...
		class="flex h-[1.125rem] min-h-[1.125rem] w-8 shrink-0 cursor-pointer items-center rounded-full px-1 mx-[1px] transition bg-gray-200 dark:bg-transparent data-[state=checked]:bg-emerald-500 data-[state=checked]:dark:bg-emerald-700 {($settings?.highContrastMode ??
		false)
