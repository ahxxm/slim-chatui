...
>
	...
	<Select.Portal>
		<Select.Content
			class="bits-content w-full rounded-lg  bg-white dark:bg-gray-900 dark:text-white shadow-lg border border-gray-300/30 dark:border-gray-700/40  outline-hidden"
			sideOffset={4}
		>
			<slot>
				{#if searchEnabled}
